...
int main(int argc,char ** argv)
{
	...
	// le programme prend 3 arguments: le nom du fichier pour créer la clé, le nombre de sémaphore ainsi que la valeur initiale
	...
	// Q: rajouter ici l'appel à la fonction ftok(), la variable k contiendra la clé extraite (retour de la fonction ftok) 
	// on pourra utiliser PRJVAL comme second paramétre de la fonction ftok
	...
	// Q: appel à la fonction semget() et mise de la valeur de retour dans la variable semid
	//--
	...
	// le tableau values contient l'ensemble des valeur avec lesquels on veut initialiser les sémaphores	

	for (s=0; s<nbSem; s++) values[s]=val;
	
	
	// Q: faites un appel à la fonction semclt() pour initialiser les sémaphore avec les valeurs se trouvant dans le tableau values
